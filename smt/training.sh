#ex. sh training.sh ludic lu chukchi
...
#удалить предыдущие модели:

mkdir ${PRE_LANGUAGE}_lm_training
mv ${PRE_LANGUAGE}test.out ${PRE_LANGUAGE}_lm_training/
echo "${PRE_LANGUAGE}test.out moved"
mv ${PRE_LANGUAGE}.test.translated.ru ${PRE_LANGUAGE}_lm_training/
echo "${PRE_LANGUAGE}.test.translated.ru moved"
mv mert_${PRE_LANGUAGE}.out ${PRE_LANGUAGE}_lm_training/
mv mert-work ${PRE_LANGUAGE}_lm_training/
mv training_${PRE_LANGUAGE}.out ${PRE_LANGUAGE}_lm_training/
mv train ${PRE_LANGUAGE}_lm_training/
mv lm ${PRE_LANGUAGE}_lm_training/
echo "lm moved"
