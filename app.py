...
if cond_submitted:
    ...
    st.write(f'SRC: "{condition_src}"')
    st.write(f'TGT: "{condition_tgt}"')
    if condition_src == '' and condition_tgt == '':
        st.table(evenki.head(50))
    else:
